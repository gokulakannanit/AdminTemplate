/*! ngTagsInput v2.3.0 License: MIT */ ! function() {
    ...
    d.directive("tagsInput", ["$timeout", "$document", "$window", "tagsInputConfig", "tiUtil",
        function(d, e, f, g, h) {
            function i(a, b, c, d) {
                var e, f, g, i = {};
                return e = function(b) {
    ...
    ]), d.directive("autoComplete", ["$document", "$timeout", "$sce", "$q", "tagsInputConfig", "tiUtil",
    ...
    ]), d.directive("tiAutocompleteMatch", ["$sce", "tiUtil",
        function(a, b) {
            return {
                restrict: "E",
                ...
                link: function(c, d, e, f) {
                    ...
                    c.$$template = h.template, c.$index = c.$parent.$index, c.$highlight = function(c) {
                    	...
                    	console.log((h.displayProperty || h.tagsInput.displayProperty),' here ', c.data)
    ...
    }), d.directive("tiAutosize", ["tagsInputConfig",
        function(a) {
            return {
                restrict: "A",
                require: "ngModel",
