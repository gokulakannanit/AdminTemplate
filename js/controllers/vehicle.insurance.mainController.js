...
MetronicApp.controller('vehicle.insurance.mainController', ['$scope', 'vehicle.insurance.service', 'modalService',
    function($scope, updateService, modalService) {
        ...
        $scope.confirmDelete = function(id){
            ...
            promise.then(function(data){
                if(data.confirmed){
                    updateService.delete({id:id}).then(getInsurance);
                }
            });
        };
